...
| **D-2025-05** | Nick Vigier, *“Subprime Code”: How Vibe Coding Could Trigger the Next Great Crash* (2025-09-16) | [Needs re-review](documentary/terminology-provenance.md) | Needs re-verification | — | The dated public use of “Subprime Code” and “subprime coding crisis” in relation to AI-assisted coding | `TERMINOLOGY_AND_ATTRIBUTION.md`; `REFERENCES.md`; terminology provenance brief |
| **D-2025-06** | Igor Światowski, *The Subprime Code Crisis Has Started* (public LinkedIn profile listing dated 2025-12-16) | [Needs re-review](documentary/terminology-provenance.md) | Needs re-verification | — | The dated public listing of an article using the full phrase “The Subprime Code Crisis” | `TERMINOLOGY_AND_ATTRIBUTION.md`; `REFERENCES.md`; terminology provenance brief |
| **D-2026-04** | Richard Ewing, *The Subprime Code Crisis* — multiple currently accessible provenance surfaces, including a CareerWin page displaying 2025-11-12, a current canonical page claiming an April 2025 origin, a publications catalog displaying March 2026, and a previously reviewed 2026-05-01 article | [Needs re-review](documentary/terminology-provenance.md) | Needs re-verification | — | The current Ewing-attributed provenance claims, dated public surfaces, and unresolved metadata inconsistencies; not an independently established first origin | `TERMINOLOGY_AND_ATTRIBUTION.md`; `REFERENCES.md`; terminology provenance brief |
| **D-2026-05** | Vitalii Oborskyi, *Ілюзія економії: чому заміна розробників на AI — це шлях до технічного дефолту* (DOU article and preserved discussion thread, 2026-01-05 onward) | [Reviewed brief](documentary/project-provenance.md) | In progress | — | A dated public precursor to this repository's delivery-system formulation and preserved refinement around generation/review asymmetry, Value Stream outcomes, review bottlenecks, and validation | `TERMINOLOGY_AND_ATTRIBUTION.md`; `README.md`; `REFERENCES.md` |
| **D-2026-06** | GitHub REST metadata for `UncertaintyArchitectureGroup/The-Subprime-Code-Crisis` (`created_at` 2026-02-06T17:16:44Z) | [Reviewed brief](documentary/project-provenance.md) | In progress | — | The platform-recorded creation timestamp of the public repository object | `TERMINOLOGY_AND_ATTRIBUTION.md`; `README.md`; `REFERENCES.md` |
| **D-2026-07** | Vitalii Oborskyi, *Субпрайм-криза коду: чому AI-асистенти роблять нас повільнішими — і дані це доводять* (DOU, 2026-02-10) | [Reviewed brief](documentary/project-provenance.md) | In progress | — | The dated public Subprime Code formulation, its stated continuity from the January article/discussion, and its explicit link to the GitHub report | `TERMINOLOGY_AND_ATTRIBUTION.md`; `README.md`; `REFERENCES.md` |
