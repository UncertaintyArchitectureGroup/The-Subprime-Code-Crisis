...
| --- | --- | --- | --- | --- | --- | --- |
| **P-2026-01** | Demirer, Musolff & Yang, *Writing Code vs. Shipping Code: Productivity Effects Across Generations of AI Coding Tools*, NBER Working Paper 35275 | [Reviewed brief](primary/2026-writing-code-vs-shipping-code.md) | Corrections required | — | Measured attenuation from coding activity toward projects, releases, and early marketplace use within the studied setting | `README.md` Crisis Map and evidence boundary; `report/01_the_illusion.md`; `report/02_broken_mechanics.md` |
