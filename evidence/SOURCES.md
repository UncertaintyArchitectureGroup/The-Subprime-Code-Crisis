...
| **D-2026-05** | Vitalii Oborskyi, *Ілюзія економії: чому заміна розробників на AI — це шлях до технічного дефолту* (DOU, 2026-01-05) | [Reviewed brief](documentary/project-provenance.md) | In progress | — | A dated public precursor to this repository's delivery-system formulation, including generation/review asymmetry, review bottleneck, and local-output versus delivery distinction | `TERMINOLOGY_AND_ATTRIBUTION.md`; `README.md`; `REFERENCES.md` |
