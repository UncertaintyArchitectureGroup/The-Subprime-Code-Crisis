...
Попередня моя стаття [«Ілюзія економії: чому заміна розробників на AI — це шлях до технічного дефолту»](https://dou.ua/forums/topic/57244/) була присвячена критиці стратегії скорочення штату інженерів, аргументуючи такий крок наявністю куплених ліцензій ШІ-асистентів (8000+ переглядів, 230+ коментарів).
